...
export const cartReducer=createReducer(initialState,{
    ...
    calculatePrice:(state)=>{
        ...
        state.subTotal+=(state.cartItems.vegCheeseBurger.quantity)*(state.cartItems.vegCheeseBurger.price);
        state.subTotal+=(state.cartItems.burgerWithFries.quantity)*(state.cartItems.burgerWithFries.price);
